...
namespace OverviewApp.ViewModels
{
    public class DatabaseConnectionViewModel : MyBaseViewModel
    {
        ...
        //    #region
        public DatabaseConnectionViewModel(IMyDbContext context, ILogger logger) : base(context, logger)
        {
        }
        //    public DatabaseConnectionViewModel(IMyDbContext Context, ILogger logger) : base(Context, logger)
        //    {
        ...
        //        set
        //        {
        //            this.RaiseAndSetIfChanged(ref sq)
        //        }
        //    }
        ...
        //        //if (SimpleIoc.Default.IsRegistered<IMyDbContext>()) SimpleIoc.Default.Unregister<SqlServerStorage>();
