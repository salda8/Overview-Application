...
namespace OverviewApp.Helpers
{
    ...
    public static class ValidationHelper
    {
        ...
        public static bool VerifyValidChars(string input, Func<char, bool> pred) => input.All(pred);
        ...
        public static bool ParseComplexLogic(string input)
        {
            return !input.IsNullOrWhiteSpace() &&
                   VerifyValidChars(input, DigitsWhiteSpaceColonOrComma_CharBoolPredicate);
        }
        ...
        {
            return !input.IsNullOrWhiteSpace() && VerifyValidChars(input, DigitsOrWhiteSpace_CharBoolPredicate);
        }
        ...
        public static bool DigitsOrWhiteSpace_CharBoolPredicate(char c) => char.IsDigit(c) || char.IsWhiteSpace(c);
    }
}