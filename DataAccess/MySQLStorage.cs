...
//{
//    public class MySQLStorage : IDataService
//    {
//        #region Fields
...
//        {
//            using (var connection = DbUtils.CreateMySqlConnection("data"))
//            {
...
//        {
//            var connection = DbUtils.CreateMySqlConnection("data");
//            bool succeeded;
//            try
//            {
//                connection.Open();
...
//            catch (Exception ex)
//            {
//                //(LogLevel.Error, "Local storage: DB connection failed with error: " + ex.Message);
//                succeeded = false;
//                return connection;
//            }
...
//        public Contract GetContract(string cntract)
//        {
...
//        public void ReqGlobalCancel(string account)
//        {
//            using (var con = Connect())
//            {
//                using (var cmd = con.CreateCommand())
//                {
//                    cmd.CommandText =
//                        "DELETE FROM openorders WHERE AccountNumber=?acc";
